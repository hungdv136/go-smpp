...
// Group returns group name of a given ID.
// For example: SubmitSM, SubmitSMResp should return the same group name.
func (id ID) Group() byte {
	b := make([]byte, 4)
...
// Key return key of header based on ID and Seq
